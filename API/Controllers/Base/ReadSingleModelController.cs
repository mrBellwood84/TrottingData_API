...
public class ReadSingleModelController<TEntity, TComplex>(IRepositoryService<TEntity, TComplex> repository)
    : ControllerBase
    ...
    where TComplex : IEntity
{
    ...
    public async Task<ActionResult<TEntity>> GetEntityById([FromRoute] string id)
    {
    ...
    {
        var dat = await repository.GetComplexByIdAsync(id);
