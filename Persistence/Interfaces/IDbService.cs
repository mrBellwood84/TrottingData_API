...
public interface IDbService<TSimple, TComplex>
{
    ...
    /// <exception cref="PersistenceMissingQueryException">Thrown when <see cref="DbService{TSimple,TComplex}.QueryIds"/> has not been configured.</exception>
    ...
    /// <exception cref="PersistenceMissingQueryException">Thrown when <see cref="DbService{TSimple,TComplex}.QuerySimpleById"/> has not been configured.</exception>
    ...
    /// <exception cref="PersistenceQueryNotAllowedException">Thrown when the query is disallowed by policy.</exception>
    /// <exception cref="PersistenceMissingQueryException">Thrown when <see cref="DbService{TSimple,TComplex}.QueryComplex"/> has not been configured.</exception>
    ...
    /// <exception cref="PersistenceMissingQueryException">Thrown when <see cref="DbService{TSimple,TComplex}.QueryComplexById"/> has not been configured.</exception>
